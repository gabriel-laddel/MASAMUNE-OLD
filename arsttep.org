...
# no "just"
# fix an experience with nixos
# hit all of "identity" "trust" "security" "ownership"
...
http://www.quora.com/How-large-is-the-Google-Chrome-team

... ad infinitum

[fn:investment] Let's say that you're living in China, and invest in a Norwegian organization that does all business in bitcoin. Assuming they're not doing anything illegal, you're in a legal gray zone. Observe how straightforwards bitcoin investments have been to date: 
...
[fn:heartbleed] See heartbleed, shell shock, [[http://en.wikipedia.org/wiki/Sony_BMG_copy_protection_rootkit_scandal][Sony]] etc.

[fn:infinite-regress-into-stupidity] Anything marketed at people incapable of programming is as doomed as anything marketed to the illiterate. It may work for a little while, but any real success translates to the death of its host.

[fn:digital-civ] Bitcoin provides the ability to transmit value, PGP allows for the unambiguous establishment of identity, the Web of trust allows for the formalization of social relations. None of them respect geographic constraints.
...
Scala is a notable failure in this regard. Watch this video: https://www.youtube.com/embed/TS1lpKBMkgg
...
converting CL to a new language, implement loop, format on new lang. If it doesn't have macros, it is irrelevant. - macroexpand if you don't like. I'm not a loop fan, but the amount of work it takes to do this makes sense - writing a whole new compiler etc. does not.
