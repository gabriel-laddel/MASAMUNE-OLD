...
;;; 
;;; - JVN
;;; - http://en.wikipedia.org/wiki/Jean_Baptiste_Joseph_Delambre
...
(defun run-or-focus-quiz ()
  (aif (stumpwm::window-by-name "quiz")
       ...
       (bt:make-thread (lambda () (run-quiz)) :name "quiz")))
...
(defun start-memory-practice (habit)
  ...
  (stumpwm::message "3.14159265358979323846264338327950288419716939937511l0")
